  ...
  constructor() {
    this.el = el('#main.screen',
      ...
      el('p', '모바일에서는 시작하기 전에 ', el('span', { style: { fontWeight: 'bold' } }, '전체화면을 눌러'),
          ' 전체화면으로 만드는 것을 권장합니다. 또, 웬만하면 화면을 가로로 해주세요. 효과음 소리가 작아서 배경음도 작게 설정했습니다. ',
          '디바이스 볼륨에 주의해주세요. 문제가 생기면 새로고침'),
      ...
      el('small', ' v1.1.6', ' (2020-10-04)', { style: { position: 'absolute', right: '6%', bottom: '5%' } }),
    );
